...
HD_PWD='C:/Users/Uzivatel/Desktop/Project/TOP_ALARM_CLOCK_NEW/TOP_ALARM_CLOCK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarm_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_alarm_clock.tcl -notrace
