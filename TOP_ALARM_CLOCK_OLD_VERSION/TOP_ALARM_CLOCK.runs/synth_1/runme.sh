...
HD_PWD='C:/Users/Uzivatel/Desktop/Project/TOP_ALARM_CLOCK_NEW/TOP_ALARM_CLOCK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarm_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_alarm_clock.tcl
